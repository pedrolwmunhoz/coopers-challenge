...
import "./GoodThingsCard.css"

const GoodThingsCard = (props) => {
  return (
    <div className='card-container'>
      <div className='iconImage-container'>
          <img className="card-image" alt="img" src = {require(`../../../data/goodThings/image${props.imgId}.png`)}/>
          <svg className='cooperIcon' width="49" height="56" viewBox="0 0 49 56" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='card-content'>
        <div className='cardText-container'>
          <div>
            <button className='function-button'>function</button>
          </div>
